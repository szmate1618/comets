...
namespace net
{
	...
	static const char* const unknown_error = "Sorry, this errorcode is totally unknown. Its numerical value is ";
	...
	static const char* const WSAENOTSOCK_text = "WSAENOTSOCK: An operation was attempted on something that is not a socket. Did you try to bind a closed one?";
